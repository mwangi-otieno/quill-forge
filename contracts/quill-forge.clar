...
(define-constant minimum-duration u144) ;; ~1 day @ 10 min blocks
(define-constant maximum-duration u20160) ;; ~14 days

;; Data Variables
(define-data-var total-supply uint u0)
(define-data-var minimum-deposit uint u1000000) ;; microSTX
...
(define-public (deposit (amount uint))
  (begin
    ...
    ;; Mint governance shares 1:1 with deposited microSTX
...
(define-public (vote
  ...
  (begin
    ...
    (let (
      ...
      ;; Tally with balance-weighted votes
      (map-set proposals proposal-id
        (merge proposal {
...
(define-public (execute-proposal (proposal-id uint))
  (begin
    ...
    (let (
      ...
      ;; Execute transfer to the approved target
